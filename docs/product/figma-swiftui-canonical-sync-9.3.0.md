# Figma and SwiftUI canonical synchronization — 9.3.0
...
## Proposed 9.3.0 canonical scope
...
are outside the first 9.3.0 slice unless a shared-component change requires
them.
